...
def _generate_architecture_ascii(containers: list, networks: list) -> list[str]:
    ...
    from ..models import ContainerCategory
...
async def get_docs():
    ...
    try:
        ...
        md.append("\n---\n")
        md.append(f"*Generated by [SockMap](https://github.com/sockmap) 🧦*")
